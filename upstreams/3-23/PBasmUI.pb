...
Procedure OptionDependencies(option)
  If option & #optSource                          ; PB source or REASM
    ...
    DisableGadget(#produceEXE,x)
    DisableGadget(#ViewDefault,x)
    DisableGadget(#viewASM,x)
    If x = 1 : SetGadgetState(#produceEXE,1) : EndIf  ; REASM: always allow path edit (though checkbox off)
  EndIf 
...
Repeat
  ...
  If Event = #PB_Event_Gadget
    ...
    Case #compileSource,#REASM : toCheck = #optSource | #optProduct 
...
; IncludeVersionInfo
; VersionField0 = 3,2,3,0
; VersionField1 = 3,2,3,0
; VersionField2 = Horst Schaeffer
; VersionField3 = PBasmUI
; VersionField4 = 3.23  %yyyy-%mm-%dd
; VersionField5 = 3.23
